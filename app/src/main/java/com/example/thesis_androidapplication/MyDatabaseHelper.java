...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CONTACTS_USER_PASSCODE = "user_passcode";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String[] querries = {
                "CREATE TABLE " + CONTACTS_TABLE_NAME + " (" + CONTACTS_COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + CONTACTS_USERNAME + " TEXT, " + CONTACTS_USER_CONTACTS + " TEXT, " + CONTACTS_USER_PASSCODE + " TEXT)",
    ...
    //add contact
    void add_thiscontact(String username, String contact, String passcode) {
        ...
        cv.put(CONTACTS_USER_PASSCODE, passcode);
    ...
    /*method for searching db for redundant random generated number*/
    Cursor searchDBforExistingPasscode(String genPasscode) {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery("SELECT * FROM " + CONTACTS_TABLE_NAME + " WHERE user_passcode = '" +genPasscode + "'",
                null);
    }
